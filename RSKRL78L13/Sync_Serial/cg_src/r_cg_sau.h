...
Macro definitions
***********************************************************************************************************************/
#define _8000_CSI00_DIVISOR              (0x8000U)
...
/* Define the data length, including the NULL character */
#define TRANSFER_LENGTH     31

/* Defines the ASCII character values */
#define ASCII_0             '0'
#define ASCII_9             '9'

/* Definition of test status */
typedef enum {TEST_IN_PROGRESS, TEST_CLK_ERR, TEST0_ERR, TEST1_ERR, TEST_FAILED, TEST_PASS} test_status_t;

/* function for Sync transfer */
void Sync_Transfer (void);

/* Declaration of the CSI00 transmit buffer */
extern char g_csi00_txbuffer[];

/* Declaration of the CSI10 transmit buffer */
extern char g_csi10_txbuffer[];

/* Declaration of CSI00 receive buffers */
extern char g_csi00_rxbuffer[];

/* Declaration of CSI10 receive buffers */
extern char g_csi10_rxbuffer[];
