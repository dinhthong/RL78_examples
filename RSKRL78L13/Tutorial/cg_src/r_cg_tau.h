...
#define _1E84_TAU_TDR01_VALUE                   (0x1E84U)
/* Clock divisor for TAU0 channel 1 */
#define TAU0_CHANNEL1_DIVISOR                   (512U)    /* fCLK/2^9 */
/* 16-bit timer data register 02 (TDR02) */
#define _9896_TAU_TDR02_VALUE                   (0x9896U)
/* Clock divisor for TAU0 channel 2 */
#define TAU0_CHANNEL2_DIVISOR                   (512U)    /* fCLK/2^9 */
...
/* Define a minimum timer period */
#define MIN_TIMER_PERIOD         (uint16_t)0x50

/* Define a timer period scaler */
#define TIMER_PERIOD_SCALER     (uint16_t)0x40
