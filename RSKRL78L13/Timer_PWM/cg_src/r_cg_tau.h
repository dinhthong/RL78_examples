...
#define _09C3_TAU_TDR02_VALUE                   (0x09C3U)
...
#define _00FA_TAU_TDR05_VALUE                   (0x00FAU)
/* Clock divisor for TAU0 channel 4 */
#define TAU0_CHANNEL4_DIVISOR                   (8U)      /* fCLK/2^3 */
/* Clock divisor for TAU0 channel 5 */
#define TAU0_CHANNEL5_DIVISOR                   (8U)      /* fCLK/2^3 */
...
/* Defines the value which to increment the duty cycle */
#define DUTY_CYCLE_STEPS            1u

/* Defines the value which to increment the duty cycle */
#define CYCLE_PERIOD                _09C3_TAU_TDR04_VALUE

/* Defines the minimum duty cycle that will be set */
#define LOWER_DUTY_CYCLE            _00FA_TAU_TDR05_VALUE

/* Defines the maximum duty cycle */
#define UPPER_DUTY_CYCLE            (CYCLE_PERIOD - LOWER_DUTY_CYCLE)

/* Switch callback function prototype */
