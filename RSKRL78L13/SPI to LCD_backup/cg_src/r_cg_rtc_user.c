...
extern volatile rtc_counter_value_t stRTC_Data;
extern volatile uint8_t time_str[10];
/* End user code. Do not edit comment generated here */
...
static void r_rtc_callback_constperiod(void)
{
  ...
  //  rtc_counter_value_t stRTC_Data;
   ...
   // char                time_str[6];
    ...
    time_str[7] = (char)((stRTC_Data.sec >> 4)  + 0x30);
    time_str[8] = (char)((stRTC_Data.sec & 0x0F) + 0x30);
    time_str[9] = (uint8_t)0x00;
