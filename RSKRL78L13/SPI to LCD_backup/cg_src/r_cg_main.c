...
void main(void)
{
    ...
    /* Start user code. Do not edit comment generated here */
	    ...
	    LCD_write_byte(0, 0xA3);   // LCD set bias_7
        LCD_write_byte(0, 0x40);	// LCD set start line
        LCD_write_byte(0, 0x2C);	// LCD set power control
        R_TAU_MsDelay(50);
        LCD_write_byte(0, 0x2E);// LCD set power control
        R_TAU_MsDelay(50);
        LCD_write_byte(0, 0x2F);// LCD set power control
        R_TAU_MsDelay(10);
        
        LCD_write_byte(0, 0xAF);// LCD display ON
        LCD_write_byte(0, 0xA4);// all pixel off

        LCD_write_byte(0, 0x81);//LCD set EV
        LCD_write_byte(0, 10);// LCD set contrast
        
        LCD_write_byte(0, 0xA1);// LCD set ADC reverse
        LCD_write_byte(0, 0xC8);// LCD set vertical direction
        LCD_write_byte(0, 0x24);// LCD set regulation ratio

        LCD_write_byte(0, 0xB0);// LCD start page
        LCD_write_byte(0, 0x04);//  LCD start column LSB byte
        LCD_write_byte(0, 0x10);//  LCD start column MSB byte

        R_TAU_MsDelay(3000);
        LCD_write_byte(0, 0xA5);
        R_TAU_MsDelay(500);
        LCD_write_byte(0, 0xA4);
        R_TAU_MsDelay(500);
        LCD_write_byte(0, 0xA5);
        R_TAU_MsDelay(500);
        LCD_write_byte(0, 0xA4);
        ...
        R_TAU_MsDelay(1500);
        LCD_write_byte(1, 0xFE);
        R_TAU_MsDelay(1500);
        LCD_write_byte(1, 0xFC);
        R_TAU_MsDelay(1500);
        LCD_write_byte(1, 0xF8);
        R_TAU_MsDelay(1500);
